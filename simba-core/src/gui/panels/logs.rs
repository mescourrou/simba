...
use egui::{Color32, FontId, ScrollArea, TextFormat, TextStyle, text::LayoutJob};

use crate::{
    context::Context,
    logger::{InternalLog, LogLevel, Logger, LoggerType},
};
...
fn egui_format_message(
    ...
    job.append("[", 0., TextFormat::simple(font_id.clone(), *default_color));
    job.append(
