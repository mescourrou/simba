...
- [`scenario`](scenario.md): Events configuration.
...
You can also use the autocompletion in VSCode. Add `# yaml-language-server: $schema=path/to/your/config.schema.json` at the top of your config file. The schema file can be found in the release or in the repository.