...
## How to create a new state estimation strategy
...
with Serialize, Deserialize, Debug, Clone and Default traits.

Add this new Config to [`StateEstimatorConfig`](state_estimator::StateEstimatorConfig) enumeration, and to the match
patterns in [`Turtlebot::from_config`](crate::turtlebot::Turtlebot::from_config) so that the right strategy is created.

TODO: Change that, make a factory.
