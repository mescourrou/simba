...
impl AdditiveRobotCenteredPolarFault {
    pub fn from_config(config: &AdditiveRobotCenteredPolarFaultConfig, va_factory: &DeterministRandomVariableFactory) -> Self {
...
impl FaultType for AdditiveRobotCenteredPolarFault {
